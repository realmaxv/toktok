...
function FeedList() {
  ...
  return (
    <div
      ...
      className="grid grid-cols-1 md:grid-cols-3 flex-col pt-16 pb-22 w-full h-screen overflow-scroll scroll-smooth divide-y divide-stone-300 dark:divide-stone-800 md:divide-x md:divide-stone-300 md:dark:divide-stone-800"
    >
      {data
